// lib/context.js — startup intelligence context for noelclaw
...
function buildContextBlock() {
  try {
    ...
    if (ctx.trades) {
      const t = ctx.trades;
      lines.push(`- Your trades (7d): ${t.trades} total, ${t.winRate}% win rate, ${t.totalPnlSol > 0 ? '+' : ''}${t.totalPnlSol} ETH P&L`);
