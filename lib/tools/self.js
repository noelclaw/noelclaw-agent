...
const HANDLERS = {
  async get_trade_history(args, ctx, _log) {
    ...
    return JSON.stringify({
      ...
      noelclawReinvest: {
        totalEthReinvested: +((reinvest.totalEthReinvested ?? reinvest.totalSolReinvested ?? 0)).toFixed(5),
        totalNoelclawBought: +((reinvest.totalNoelclawBought ?? reinvest.totalCircuitBought ?? 0)).toFixed(2),
