...
const DEFINITIONS = [
  {
    ...
    function: {
      name: 'check_wallet',
      description: 'Check your agent wallet: ETH balance, NOELCLAW balance, and all open trading positions with current P&L.',
  ...
  },
  {
    ...
    function: {
      name: 'send_token',
      description: 'Send ERC-20 tokens directly from your wallet to another EVM address on Base. Use this to transfer NOELCLAW or any other held token to any EVM address. Returns transaction hash on success.',
      parameters: {
        type: 'object',
        properties: {
          mint:      { type: 'string', description: 'Token contract address (EVM hex, e.g. NOELCLAW token: 0x4B524015D54a27d4472F5c59c570730D69499Ba3)' },
          toAddress: { type: 'string', description: 'Destination EVM wallet address (0x...)' },
          amount:    { type: 'number', description: 'Amount to send in token UI units (e.g. 1000 for 1000 NOELCLAW)' },
        },
