...
const DEFINITIONS = [
  // ── Swarm intelligence tools ───────────────────────────────────────────────
  {
    ...
    function: {
      ...
      description: 'Read recent buy/sell/rug signals from the swarm feed. See recent market signals. Filter by type or token. (Currently returns empty — swarm features are no-ops in this deployment.)',
      parameters: {
        type: 'object',
        properties: {
