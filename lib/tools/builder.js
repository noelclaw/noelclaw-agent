...
const DEFINITIONS = [
  {
    ...
    function: {
      name: 'read_file',
      description: "Read any file under the user's home directory. Accepts absolute paths or relative paths within the agent dir. Always read before writing.",
      parameters: {
        type: 'object',
        properties: {
          path:   { type: 'string', description: 'Absolute path or relative path within agent dir (e.g. lib/tools/builder.js, scripts/performance.js)' },
